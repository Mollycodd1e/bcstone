...
export const C_ContentAbout = ({className, data, setIsPopupClose, setIsAboutPopupClose, popup, isWebp}) => {
    ...
    return (
        <div className={classNames(cls, {[classes.video]: isVideo})}>
            <C_SliderVideoAbout className={classes.C_SliderVideoAbout} data={data} setIsAboutPopupClose={setIsAboutPopupClose} setIsVideo={setIsVideo} popup={popup} isWebp={isWebp}/>
