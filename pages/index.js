        ...
        <Context.Provider value={[width, height]}>
            <div className={"page-wrapper"}>
                ...
                <div className={`common_top_bg`} ref={topMenuEl}>
                    ...
                    <S_Footer phone_number={mocks.contacts.phone} mail={mocks.contacts.mail}
                              address={mocks.contacts.address} sales_number={mocks.contacts.sales}
                              telegram={mocks.contacts.telegram} copyright={mocks.copyright}/>
                </div>
            </div>
